...
func (*UserOpService) GetFavList(ctx context.Context, req *proto.UserFavRequest) (*proto.UserFavListResponse, error) {
...
func (*UserOpService) AddUserFav(ctx context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
...
func (*UserOpService) DeleteUserFav(ctx context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
...
func (*UserOpService) GetUserFavDetail(ctx context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
	var userfav model.UserFav
