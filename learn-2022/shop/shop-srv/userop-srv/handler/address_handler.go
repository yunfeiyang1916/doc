...
import (
	...
	"shop/shop-srv/userop-srv/model"
...
func (*UserOpService) GetAddressList(ctx context.Context, req *proto.AddressRequest) (*proto.AddressListResponse, error) {
...
func (*UserOpService) CreateAddress(ctx context.Context, req *proto.AddressRequest) (*proto.AddressResponse, error) {
...
func (*UserOpService) DeleteAddress(ctx context.Context, req *proto.AddressRequest) (*emptypb.Empty, error) {
...
func (*UserOpService) UpdateAddress(ctx context.Context, req *proto.AddressRequest) (*emptypb.Empty, error) {
	var address model.Address
