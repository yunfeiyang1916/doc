...
import (
	...
	"shop/shop-srv/userop-srv/handler"
	"shop/shop-srv/userop-srv/initialize"
	"shop/shop-srv/userop-srv/proto"
	"shop/shop-srv/userop-srv/utils"
	"syscall"
...
func main() {
	...
	proto.RegisterUserFavServer(server, &handler.UserOpService{})
	// 注册服务健康检查
