...
type GoodsClient interface {
	...
	// 获取所有的分类
	GetAllCategoryList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error)
	// 获取子分类
...
func (c *goodsClient) GetAllCategoryList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
type GoodsServer interface {
	...
	// 获取所有的分类
	GetAllCategoryList(context.Context, *empty.Empty) (*CategoryListResponse, error)
	// 获取子分类
...
func (UnimplementedGoodsServer) GetAllCategoryList(context.Context, *empty.Empty) (*CategoryListResponse, error) {
...
func _Goods_GetAllCategoryList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetAllCategoryList(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
